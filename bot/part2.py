...
def get_wall_posts2(group_name):
                ...
                if "attachments" in post:
                    ...
                    if len(post) == 1:
                        ...
                        # забираем видео
                            ...
                            video_get_url = f"https://api.vk.com/method/video.get?videos={video_owner_id}_{video_post_id}_{video_access_key}&access_token={my_secret}&v=5.157"
